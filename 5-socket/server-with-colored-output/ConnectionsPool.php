    ...
    private function initEvents(ConnectionInterface $connection): void
    {
        ...
        $connection->on(
            ...
            function ($data) use ($connection) {
                ...
                $this->sendAll($this->output->message($name, $data), $connection);
            }
        );
        ...
        $connection->on(
            ...
            function () use ($connection) {
                ...
                $this->sendAll($this->output->warning("User $name leaves the chat\n"), $connection);
            }
        );
    }

    private function checkIsUniqueName(string $name): bool
    {
